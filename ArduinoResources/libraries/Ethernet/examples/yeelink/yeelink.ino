...
// for yeelink api
#define APIKEY         "90a0a22b9658b99594caef47b3247a46" // replace your yeelink api key here
#define DEVICEID       340660 // replace your device ID
#define SENSORID       377377 // replace your sensor ID
